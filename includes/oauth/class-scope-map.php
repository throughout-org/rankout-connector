...
class Scope_Map {
    ...
    const SCOPE_MAP = array(
        ...
        'mcp:site_health:read'   => array( 'wp_get_site_health' ),
        'mcp:reporting:read'     => array( 'wp_seo_audit_site', 'wp_content_gap_report' ),
        'mcp:schema:read'        => array( 'wp_get_post_schema', 'wp_audit_schema_coverage', 'wp_list_schema_types' ),
        'mcp:schema:write'       => array( 'wp_update_post_schema' ),
        'mcp:geo:read'           => array( 'wp_audit_geo_readiness', 'wp_get_llms_txt', 'wp_get_entity_context' ),
        'mcp:geo:write'          => array( 'wp_update_llms_txt' ),
        'mcp:aeo:read'           => array( 'wp_get_faq_blocks', 'wp_audit_answer_readiness' ),
        'mcp:aeo:write'          => array( 'wp_create_faq_block' ),
        'mcp:eeat:read'          => array( 'wp_get_content_freshness', 'wp_suggest_internal_links', 'wp_get_eeat_signals', 'wp_get_internal_links' ),
